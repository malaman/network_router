...
class MyTestCase(unittest.TestCase):
    def test_create_with_string(self):
        ...
        self.assertEqual(ip.to_long(), 2131504406)
        self.assertEqual(ip.to_string(), '127.12.45.22')

        ip = IPv4Address('0.0.0.0')
        self.assertEqual(ip.to_long(), 0)
        self.assertEqual(ip.to_string(), '0.0.0.0')

        ip = IPv4Address('255.255.255.255')
        self.assertEqual(ip.to_long(), 4294967295)
        self.assertEqual(ip.to_string(), '255.255.255.255')
